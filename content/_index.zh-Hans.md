...
### 从 [AppStore][appstore]、[Google Play][googleplay]、[FDroid][fdroid]、[华为 AppGallery][appgallery], [Obtainium][obtainium]、[Accrescent][accrescent] 下载并安装Organic Maps {#install}
...
以下亲爱的机构赞助商提供了有针对性的资助，以支付部分基础设施成本并资助新选定功能的开发：
