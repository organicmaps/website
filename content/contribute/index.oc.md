...
- Ajudatz-nos a [fix bugs][contributing] e repassar lo còde se siatz desvelopaire. Cada dificultat reglada fa plaser en quauqu’un.
- [Translate][translations] cadenas mancan dins l’interfàcia de l’aplicacion.
- Tradurre lei descripcions de [App Store][translations_appstore] e [Android][translations_googleplay] dins vòstra lenga.
- [Traduir][translations_website] nòstre site internet dins vòstra lenga.
- Jonhètz-vos a la comunautat [OpenStreetMap][openstreetmap] e collaboratz a la mapa.
...
- Ajudatz leis autreis utilizators dins [GitHub][issues], [Telegram][telegram_chat], [Matrix][matrix], [Twitter][twitter], [Facebook][facebook], [Instagram][instagram].
