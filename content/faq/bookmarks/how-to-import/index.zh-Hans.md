...
你可以导入从 Organic Maps 或第三方应用发送的以 KML、KMZ、KMB、GPX 格式导出的书签：

1. 你可以从文件夹和应用程序（包括 Maps.Me）导入书签。 按下星形按钮打开书签，按下“导入书签和轨迹”，然后选择带有 KML、KMZ、KMB、GPX 文件的驱动器或文件夹。
...
4. 将会在 Organic Maps 中打开，你将看到书签成功加载的提示。你可以在地图上或在书签菜单屏幕中找到它们。
