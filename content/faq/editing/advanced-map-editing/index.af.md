...
1. Skep 'n nuwe rekening of meld aan by [OpenStreetMap.org](https://www.openstreetmap.org)
2. Blaai na die ligging wat jy wil wysig op OpenStreetMap.org en klik *Redigeer* boaan
3. *Begin die Walkthrough* en volg die kort tutoriaal wat die ID Editor verduidelik
4. Wysig die kaart
5. Laai jou veranderinge op

Dit is dit, jy is nou deel van die OSM-gemeenskap.
...
OpenStreetMap is 'n gemeenskap. As jy hulp nodig het of enige vrae het, kan jy in die [OSM Forum](https://community.openstreetmap.org/c/help-and-support) vra of kyk na die [OSM Wiki](https://wiki.openstreetmap.org/) dokumentasie.

## Merkers - Hoe die OSM-datamodel werk
...
As jy nie tyd het nie of die probleem te ingewikkeld is om self die OSM-data te redigeer, is OSM Notes ([Wiki](https://wiki.openstreetmap.org/wiki/Notes)) die pad om te gaan. Jy kan so 'n nota in die ligging van die kaartfout plaas en die probleem in detail beskryf. Ander OSM-vrywilligers kan dan help en die probleem oplos. Jy sal e-poskennisgewings via jou OSM-rekening kry ingeval hulle verdere vrae het of die OSM-nota opgelos word.

1. Skep 'n nuwe rekening of meld aan by [OpenStreetMap.org](https://www.openstreetmap.org)
   > Jy kan ook anonieme notas oopmaak, maar dit word nie aanbeveel nie aangesien jy nie in kennis gestel sal word wanneer die probleem opgelos is of daar verdere vrae is nie.
2. Zoem na die kaartligging op [OpenStreetMap.org](https://www.openstreetmap.org) en druk *Voeg 'n nota by die kaart* (tweede ikoon van onder op die regterkieslys). Sleep dan die blou kaartmerker na die presiese ligging.
   > Probeer om so akkuraat te wees as wat jy kan.
3. Verskaf 'n gedetailleerde beskrywing van die kaartprobleem en druk *Voeg Nota by*
   > Vir winkels bv. verskaf die naam en noem wat daar verkoop word of watter dienste aangebied word.
