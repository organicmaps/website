...
یک رستوران به عنوان مثال به عنوان یک یادداشت یا منطقه با برچسب ``` amenity=restaurant`` نگاشت شده است. برچسب‌های بیشتری مانند ```cousine=*``` یا ``opening_hours=*``` می‌توانند برای جزئیات بیشتر استفاده شوند.
