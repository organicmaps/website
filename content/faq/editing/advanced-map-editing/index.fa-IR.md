...
1. یک حساب کاربری جدید ایجاد کنید یا در [OpenStreetMap.org](https://www.openstreetmap.org) وارد شوید
2. مکان مورد نظر برای ویرایش را در OpenStreetMap.org مرور کنید و روی *Edit* در بالا کلیک کنید.
3. *Walkthrough* را شروع کنید و آموزش کوتاهی را که ID Editor را توضیح می دهد دنبال کنید
...
> توجه داشته باشید که ID editor ساختار داده های داخلی را از کاربران پنهان می کند تا مبتدی تر باشد. اما برای خواندن اسناد ویکی، مروری کوتاه بر ساختار داده مفید است.
در ID Editor، می‌توانید برچسب‌هایی را که ID از شما پنهان می‌کند، با گسترش بخش *برچسب‌ها* در پانل کناری *ویژگی ویرایش* مشاهده کنید.
