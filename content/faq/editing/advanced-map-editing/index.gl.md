...
Para editar OSM, hai varias opcións. Se tes un ordenador portátil ou de escritorio a man, é mellor utilizar o [ID Editor](https://www.openstreetmap.org/edit) que se executa no teu navegador. O ID Editor é sinxelo para os principiantes, e unha pantalla, rato e teclado máis grandes facilitan a edición de mapas.
