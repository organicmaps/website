...
Omdat alle kaartgegevens die in Organic Maps worden gebruikt, afkomstig zijn van [OpenStreetMap.org (OSM)](https://www.openstreetmap.org), kunt u de kaart daar direct bijwerken. Uw wijzigingen worden vervolgens bij de volgende kaartupdate opgenomen in Organic Maps.
...
Zodra u op *Upload* drukt, worden uw wijzigingen onmiddellijk toegevoegd aan de openbare database van OSM. Wees dus attent bij het bewerken. In Organic Maps zijn uw wijzigingen zichtbaar na de volgende maandelijkse kaartupdate.
