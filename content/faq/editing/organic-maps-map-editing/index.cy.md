...
**I olygu OpenStreetMap o'ch ap Organic Maps:**
1. Creu cyfrif yn [OpenStreetMap.org]( https://www.openstreetmap.org/user/new )
2. Mewngofnodwch i'ch cyfrif yn Organic Maps (eicon byrgyr -> *gosodiadau* -> *OpenStreetMap-Profile*)
3. Nawr gallwch olygu lleoedd presennol neu ychwanegu rhai newydd
	- Golygu lle presennol
		- dewiswch y lle trwy dapio ar eicon y map
		- tap * golygu man*
		- Ychwanegu gwybodaeth ychwanegol
		- Arbedwch eich newidiadau ac ymadael gan ddefnyddio'r saeth wirio
	- Ychwanegu lle i'r map
