...
La aplicación de escritorio de Linux se utiliza principalmente con fines de desarrollo (pruebas automatizadas y verificación de lógica sin tener que compilar para dispositivos móviles). ¡Cualquier voluntario para mejorar la usabilidad de la versión de Linux es bienvenido!
