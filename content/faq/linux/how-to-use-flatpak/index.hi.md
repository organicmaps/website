...
description: Organic Maps एप्लिकेशन के लिए अक्सर पूछे जाने वाले प्रश्न
taxonomies:
  faq:
    - linux
extra:
...
फ्लैटपैक के साथ लिनक्स पर OM स्थापित करने के लिए, टर्मिनल खोलें और इनपुट करें `flatpak install flathub app.organicmaps.desktop`
