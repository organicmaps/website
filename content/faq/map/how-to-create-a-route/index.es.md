...
Puedes agregar hasta 100 puntos intermedios a una ruta. Para agregar un punto intermedio: crea una ruta entre un inicio y un destino → luego toca un punto en el mapa y toca “Añadir parada”.

Puedes cambiar la configuración de la ruta del automóvil y seleccionar los tipos de carreteras que te gustaría evitar (peajes, carreteras sin pavimentar, autopistas, transbordadores). Abre la configuración de la aplicación → Configuración de desvío → Activar las opciones necesarias.
