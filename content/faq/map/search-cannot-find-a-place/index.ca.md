...
A més, és possible que el lloc encara no s'hagi afegit al mapa a [OpenStreetMap.org](https://www.openstreetmap.org/). Si voleu ajudar i millorar el mapa, consulteu [aquesta guia](https://wiki.openstreetmap.org/wiki/Contribute_map_data) i afegiu vosaltres mateixos la informació del mapa que falti.

Si el lloc es mostra al mapa a Organic Maps, però la nostra cerca no el troba, [denuncia'ns](mailto:support@organicmaps.app) coordenades del lloc i un exemple de la teva sol·licitud de cerca.
