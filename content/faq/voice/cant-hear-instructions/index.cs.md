...
* Ujistěte se, že hlasitost vašeho zařízení není ztlumená. Úroveň hlasitosti můžete změnit pomocí tlačítek hlasitosti vašeho zařízení. Chcete-li to provést, možná budete muset deaktivovat možnost „Změnit pomocí tlačítek“ (pokud je povolena) v nastavení zařízení → Zvuky.
...
* Pokud jste uživatelem systému Android a tato možnost je zakázána (nebo některé z podporovaných jazyků nejsou k dispozici), zkontrolujte [nastavení TTS] (@/faq/voice/text-to-speech-android-tts/index.md).
