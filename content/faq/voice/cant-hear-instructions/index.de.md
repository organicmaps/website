...
* Stellen Sie bitte sicher, dass die Lautstärke Ihres Geräts nicht stummgeschaltet ist. Sie können die Lautstärke mit den Lautstärketasten Ihres Geräts ändern. Dazu müssen Sie möglicherweise die Option "Mit Tasten ändern" (falls aktiviert) in den Geräteeinstellungen → Töne & Vibration deaktivieren.

* Melden Sie uns bitte Bluetooth Probleme inklusive aller Details auf unserem [GitHub](https://github.com/organicmaps/organicmaps/issues)

* Wenn Sie Android verwenden und die Einstellung deaktiviert ist (oder einige der unterstützten Sprachen nicht verfügbar sind), überprüfen Sie die [System TTS(Text-zu-Sprache) Einstellungen](@/faq/voice/text-to-speech-android-tts/index.md).
