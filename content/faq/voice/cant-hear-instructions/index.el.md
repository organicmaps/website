...
* Εάν είστε χρήστης Android και η επιλογή είναι απενεργοποιημένη (ή ορισμένες από τις υποστηριζόμενες γλώσσες δεν είναι διαθέσιμες), ελέγξτε τις [ρυθμίσεις TTS](@/faq/voice/text-to-speech-android-tts/index.el.md).
