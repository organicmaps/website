...
برای آزمایش دستورالعمل‌های صوتی، می‌توانید در منوی OM «تنظیمات → دستورالعمل‌های صوتی» روی «Test Voice Directions (TTS, Text-to-Speech)» ضربه بزنید یا در واقع می‌توانید یک ناوبری را برای دریافت هر خروجی صوتی شروع کنید. Organic Maps در حالی که ساکن هستید هیچ دستورالعمل صوتی به شما نمی دهد.
