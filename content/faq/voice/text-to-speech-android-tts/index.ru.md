...
Чтобы проверить голосовые инструкции, вы можете нажать на «Проверить голосовые подсказки (TTS, Text-To-Speech)» в меню OM «Настройки → Голосовые инструкции» или начать навигацию, чтобы услышать голосовые инструкции. Пока вы стоите на месте, Organic Maps не будет давать голосовых инструкций.
