...
Android:
* Vyřešen systémový dialog „Povolit polohu“ v některých případech
* Vyřešen pád v režimu rozdělené obrazovky & při otočení obrazovky na šířku/výšku
* Spolehlivější šipka kompasu na stránce místa
...
* Aktualizovány ikonky jeskyní, horských průsmyků, vrcholů, sopek, tísňových telefonů, historických lodí, zmrzlin, nočních klubů, hudebních obchodů, stadionů, videoher
