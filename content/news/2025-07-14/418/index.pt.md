...
Conhece a atualização de julho do Organic Maps com muitas correções e melhorias, graças aos nossos colaboradores ❤️💪! A atualização já está disponível na [AppStore][appstore], [Obtainium][obtainium] e [Accrescent][accrescent], e estará pronta no [Google Play][googleplay], [Huawei AppGallery][appgallery], e [FDroid][fdroid] dentro de alguns dias.

[As tuas doações](@/donate/index.pt.md) e [apoio](@/contribute/index.pt.md), [relatórios de erros][github issues] e [melhorias][github] ajudam-nos a fazer mapas melhores juntos!

Não te esqueças de que podes inscrever-te no programa de testes beta para obter acesso antecipado a funcionalidades experimentais e futuras [para iOS][testflight] e [para Android][firebase].
...
- Agora podes editar ou eliminar o percurso gravado imediatamente após o guardar
