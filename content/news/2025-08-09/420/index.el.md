...
Εγκατάστησε την έκδοση Αυγούστου του Organic Maps, κατέβασε τους πιο πρόσφατους χάρτες και ανακάλυψε δημοφιλείς διαδρομές πεζοπορίας και ποδηλασίας σε όλο τον κόσμο! Πάτησε το κουμπί «Επίπεδα» στην επάνω αριστερή γωνία για να δεις χρωματιστές διαδρομές ποδηλάτου και ορεινής ποδηλασίας, καθώς και επίσημα μονοπάτια πεζοπορίας και περπατήματος. Δεν βλέπεις κάτι κοντά σου; Τότε ήρθε η ώρα να προσθέσεις τις πληροφορίες που λείπουν στο OpenStreetMap.org, αφού όλα τα δεδομένα χάρτη στο Organic Maps προέρχονται από αυτό το ανοιχτό, δωρεάν και υποστηριζόμενο από την κοινότητα έργο.

Γνώριζες ότι οποιαδήποτε καταγεγραμμένη ή εισαγόμενη διαδρομή GPX/KML στο χάρτη μπορεί να επιλεγεί; Οι διαδρομές με δεδομένα υψομέτρου θα εμφανίζουν το γράφημα υψομέτρου τους.

Για να δεις ονόματα σελιδοδεικτών στο χάρτη, ενεργοποίησε αυτή τη νέα λειτουργία στις ρυθμίσεις του Organic Maps.

Χάρη στους συνεισφέροντες μας ❤️ και στις [δωρεές](@/donate/index.el.md) σου, υπάρχουν πολλά περισσότερα σε αυτήν την ενημέρωση.

Υ.Γ. …και πολλά περισσότερα έρχονται! Η υποστήριξή σου μας βοηθά και μας παρακινεί να δημιουργήσουμε τους καλύτερους χάρτες – μαζί.
