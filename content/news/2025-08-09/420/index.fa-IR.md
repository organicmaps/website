...
- نمایش مسیرهای پیاده‌روی و دوچرخه‌سواری از OpenStreetMap (Viktor Govako)
- نمایش نام‌های نشانک روی نقشه (Viktor Govako، Alexander Borsuk، Kiryl Kaveryn)
- داده‌های OpenStreetMap به‌روز شده تا 4 آگوست
- رفع مشکل نقاط شروع/پایان گمشده هنگام ضبط مسیر (Viktor Govako)
- جاده‌های کشاورزی و جنگلی اکنون از مسیریابی حذف شده‌اند (Viktor Govako)

#### iOS

- رفع چندین خرابی و بهبود ثبات همگام‌سازی iCloud (Kiryl Kaveryn)
- معرفی عناوین چندخطی در فهرست‌های نشانک (David Martinez)
- رفع مشکل بزرگنمایی هنگام لغو انتخاب یک مسیر (Kiryl Kaveryn)
- اصلاح ترجمه‌های گمشده ATM (Alexander Borsuk)
- رفع مشکلات مربوط به باز کردن وب‌سایت‌ها با کاراکترهای درصد-کدشده (Alexander Borsuk)
- جایگزینی ترجمه‌های گمشده با گزینه‌های انگلیسی (Viktor Govako)

#### اندروید

- افزودن نمودار ارتفاع مسیر و انتخاب مسیر روی نقشه (Kavi Khalique)
...
- نمایش آیکون‌های نشانک در انتخابگر رنگ (Andrei Shkrob)

#### بهبودهای سبک و آیکون

- آیکون چنگال و کارد برای فودکورت‌ها (David Martinez)
- علامت‌گذاری تالاب‌ها با هاشور افقی (Viktor Govako)
- آیکون‌ها برای فست‌فود و دوچرخه‌ها در نتایج جستجو و نشانک‌ها (David Martinez)
- پارکینگ سرپوشیده دوچرخه، کمدهای نگهداری چمدان و بازی‌های فرار (David Martinez)
- ایستگاه‌های محیط‌بانی و شرکای اداره پست (Viktor Govako)
- نمایش بازارچه‌ها، مناطق استراحت، مکان‌های خدماتی، مناطق خرید و پارک‌های آبی (Viktor Govako)
- اصلاح نمایش رنگ برای جنگل‌ها، بوته‌زارها و چمنزارها در تمام سطوح بزرگنمایی (Viktor Govako)
- اصلاح تنظیمات اولویت برای دفاتر دیپلماتیک (Viktor Govako)
...
- باز کردن در برنامه دیگر اکنون نقطه انتخاب‌شده را در Google Maps نمایش می‌دهد (Alexander Borsuk)
- ترجمه اسپانیایی برای دسته‌بندی‌های بیشتر جستجو (David Martinez)
