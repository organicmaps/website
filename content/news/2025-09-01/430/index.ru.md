...
Мы бесконечно благодарны ❤️ всем нашим контрибуторам, а также благодарны за [ваши пожертвования](@/donate/index.ru.md) и [вашу поддержку](@/contribute/index.ru.md).
...
- Многострочные заголовки теперь поддерживаются при выборе списка меток (David Martinez) и на странице информации о месте (Kiryl Kaveryn)
...
- Кнопка «Обновить карты для внесения правок» теперь показывается в меню, если карты слишком устарели (Kiryl Kaveryn)
