...
И, конечно, напоминание о недавних функциях, которые вы могли пропустить:
...
Organic Maps возможен благодаря всем участникам-контрибуторам, [вашим пожертвованиям](@/donate/index.ru.md) и [вашей поддержке](@/contribute/index.ru.md).
...
- Убран угол азимута к северу из превью информации о месте (чтобы увидеть его, нажмите на синюю стрелку с расстоянием) (Alexander Borsuk)

Скачайте последнюю версию Organic Maps в [App Store][appstore], [Google Play][googleplay], [Huawei AppGallery][appgallery], [Obtainium][obtainium], [Accrescent][accrescent] и [F-Droid][fdroid].
