...
Στην έκδοση της 23ης Οκτωβρίου επικεντρωθήκαμε σε διορθώσεις και βελτιώσεις. Έλεγξε την αναλυτική λίστα παρακάτω.
...
) πρόσθεσε εισαγωγή GeoJSON, στατιστικά εγγραφής διαδρομών, εμφάνιση ορίου ταχύτητας στο Android Auto, εμφάνιση ετικετών περιγραφής OSM (πληκτρολόγησε `?description` στο πλαίσιο αναζήτησης για να τις δεις), αποθήκευση σελιδοδείκτη σε μια διαδρομή στο iOS και πολλές άλλες βελτιώσεις.
...
- Το Organic Maps ενδέχεται να σου ζητήσει να το αξιολογήσεις στο App Store. Οι καλές σου αξιολογήσεις παρακινούν την ομάδα μας!
...
Το Organic Maps είναι δυνατό χάρη ❤️ στους συνεισφέροντές μας, [τις δωρεές σου](@/donate/index.el.md) και [την υποστήριξή σου](@/contribute/index.el.md).

Απόκτησε την πιο πρόσφατη έκδοση του Organic Maps από το [App Store][appstore], το [Google Play][googleplay], το [Huawei AppGallery][appgallery], το [Obtainium][obtainium], το [Accrescent][accrescent] και το [F-Droid][fdroid].

Υ.Γ. Συμμετάσχε στις δοκιμές beta για νέες λειτουργίες:
- [iOS][testflight]
- [Android][firebase].
