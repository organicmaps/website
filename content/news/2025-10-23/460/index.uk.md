...
- Показ назв входів/виходів метро на мапі (Viktor Govako)
...
- На деяких пристроях/екранах мапа в центрах міст тепер менш загромаджена (Viktor Govako)
- Виправлено повороти мапи при поганих датчиках компаса під час ходьби в режимі пішохідної навігації (Viktor Govako)
...
- Підтримуються додаткові кольори для маркованих стежок для шару мапи піших маршрутів (Viktor Govako)
