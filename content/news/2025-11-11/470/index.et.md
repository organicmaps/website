---
title: "Detailsem maailmakaart koos allalaaditud kaardipiirkondade esiletõstmisega, tingimusliku marsruutimise toega ja palju muud 11. novembri 2025 Organic Mapsi versioonis"
date: 2025-11-11
...
- Parandatud probleem vaike- ja lokaliseeritud tänavanimedega aadresside redigeerimisel ja muudatuste üleslaadimisel OpenStreetMapi (Viktor Govako)
- Parandatud suumitase, mida rakendati maailmakaardilt otsingutulemustele koputades (Viktor Govako)
- Parandatud juhtumid, kus navigeerimise automaatse suumimise seade ei töötanud (Viktor Govako)
...
- Vahetatud 'hüljatud' ja 'kasutusest kõrvaldatud' raudteede renderdamine (Lukas Hamm)
- Lisatud kaardile kellassepad ja üliõpilaste majutuskohad (David Martinez)
- Lisatud reisibüroo ikoonid (David Martinez)
...
- Lisatud sloveeni keele otsingusünonüümid ja lubatud kategooriaotsing sloveeni keeles (Alexander Borsuk)
- Parandatud trükivead, valed tõlked ja otsingusünonüümid ning lisatud puuduvad tõlked araabia, bulgaaria, taani, saksa, kreeka, hispaania, pärsia (farsi), soome, ungari, indoneesia, jaapani, korea, leedu, läti, norra bokmåli, hollandi, rumeenia ja sloveeni keelele (Alexander Borsuk)
- Lisatud spetsiaalsed tõlked Mehhiko hispaania (es-MX) ja Brasiilia portugali (pt-BR) keelele, mis erinevad tavalisest hispaania (es) ja portugali (pt) keelest (Alexander Borsuk)
- Parandatud tšehhi TTS-i hääljuhised (jxsv)
- Lubatud TTS-i hääljuhised eesti (et), galeegi (gl), heebrea (he) ja leedu (lt) keelele (Sergiy Kozyr)
- Värskendatud tõlked (Sergiy Kozyr, Weblate'i kaastöötajad)
