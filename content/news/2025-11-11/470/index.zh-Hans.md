---
title: "2025年11月11日Organic Maps版本中更详细的世界地图，带有突出显示的已下载地图区域、条件路由支持等功能"
date: 2025-11-11
slug: "xiangxi-shijie-ditu-tuchu-xianshi-yixiazai-quyu-tiaojian-luxian-guihua-zhichi-carplay-android-auto-chromebook"
taxonomies:
  news: ["releases"]
---
...
- 修复了从世界地图点击搜索结果时应用的缩放级别 (Viktor Govako)
- 修复了导航自动缩放设置不起作用的情况 (Viktor Govako)
...
- 更新了文本转语音 (TTS) 设置 (Andrei Shkrob)
- 修复了Android Auto崩溃 (Andrei Shkrob)
...
- 更新了听力学家、足病医生、验光师和助听器图标 (David Martinez)
- 修复了深色模式下的自行车租赁图标 (David Martinez)
- 在世界地图上更早显示美国和加拿大州名（从缩放级别 5 开始） (Viktor Govako)

### 翻译

- 添加了斯洛文尼亚语搜索同义词并启用了斯洛文尼亚语类别搜索 (Alexander Borsuk)
- 修复了阿拉伯语、保加利亚语、丹麦语、德语、希腊语、西班牙语、波斯语（波斯语）、芬兰语、匈牙利语、印度尼西亚语、日语、韩语、立陶宛语、拉脱维亚语、挪威博克马尔语、荷兰语、罗马尼亚语和斯洛文尼亚语的拼写错误、错误翻译和搜索同义词，并添加了缺失的翻译 (Alexander Borsuk)
- 添加了墨西哥西班牙语 (es-MX) 和巴西葡萄牙语 (pt-BR) 的专用翻译，与标准西班牙语 (es) 和葡萄牙语 (pt) 不同 (Alexander Borsuk)
- 更正了捷克语TTS语音方向 (jxsv)
- 启用了爱沙尼亚语 (et)、加利西亚语 (gl)、希伯来语 (he) 和立陶宛语 (lt) 的TTS语音方向 (Sergiy Kozyr)
- 更新了翻译 (Sergiy Kozyr, Weblate贡献者)

### 桌面版

- 在桌面版上下文菜单中显示世界地图功能——如自然保护区和湖泊 (Viktor Govako)
