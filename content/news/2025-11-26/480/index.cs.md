...
- Klepni na název seznamu na stránce s informacemi o místě a vyber nový seznam pro záložku nebo trasu. Pomocí nového vyhledávání rychle najdeš požadovaný seznam. _(Kiryl Kaveryn)_
...
- Když přesuneš trasu do seznamu, tento seznam se stane výchozím pro nové záložky a trasy. _(Kiryl Kaveryn)_
...
Přečti si [předchozí poznámky k vydání](@/news/2025-11-11/470/index.cs.md), pokud jsi je zmeškal.

### Program beta testování

Připoj se k beta testování a získej předběžný přístup k novým funkcím a pomoz nám dříve najít chyby:
- [iOS][testflight]
- [Android][firebase]

Organic Maps by nebylo možné bez tvých [darů](@/donate/index.cs.md), [příspěvků a podpory](@/contribute/index.cs.md) ❤️
