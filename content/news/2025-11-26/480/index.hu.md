---
title: "Új Organic Maps kiadás 2025.11.25: Wikipédia cikkek törökül, japánul és kínaiul, beállítás a letöltött régiók megjelenítéséhez és még sok más!"
date: 2025-11-28
...
### iOS
- ÚJ! Szerkesztheti a könyvjelző vagy útvonal nevét közvetlenül a Hely információs oldalon a névre koppintva. _(Kiryl Kaveryn)_
- iOS 26 és macOS 26 "Liquid Glass" támogatás hozzáadva. _(Kiryl Kaveryn)_
- Hosszan érintse meg a kiválasztott hely vagy könyvjelző nevét vagy címét a vágólapra másoláshoz. _(Kiryl Kaveryn)_
- Koppintson a lista nevére a Hely információs oldalon, hogy új listát válasszon a könyvjelzőhöz vagy útvonalhoz, és használja az új keresést a kívánt lista gyors megtalálásához. _(Kiryl Kaveryn)_
...
- Javított GeoJSON importálás, beleértve a `Saved Places.json` könyvjelzőket a [Google Takeout-ból](https://takeout.google.com/) _(Sergiy Kozyr)_
- A `.json` fájlok mostantól `.geojson` fájlokként is importálhatók. _(Alexander Borsuk)_
- Amikor áthelyez egy útvonalat egy listára, az a lista lesz az alapértelmezett az új könyvjelzők és útvonalak számára. _(Kiryl Kaveryn)_
- Frissített fordítások több nyelvre, beleértve a héber javítását. _(Alexander Borsuk, Michael Zeevi)_
- Egyszerűsített körforgalmi irányok. _(Viktor Govako)_

### Korábbi kiadási megjegyzések

Olvassa el a [korábbi kiadási megjegyzéseket](@/news/2025-11-11/470/index.hu.md), ha lemaradt róla.

### Béta tesztelési program

Csatlakozzon a béta teszteléshez, hogy korai hozzáférést kapjon az új funkciókhoz és segítsen nekünk hamarabb megtalálni a hibákat:
- [iOS][testflight]
- [Android][firebase]

Az Organic Maps nem lenne lehetséges az Ön [adományai](@/donate/index.hu.md), [hozzájárulásai és támogatása](@/contribute/index.hu.md) nélkül ❤️
