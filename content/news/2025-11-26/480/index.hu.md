...
- Amikor áthelyezel egy útvonalat egy listára, az a lista lesz az alapértelmezett az új könyvjelzők és útvonalak számára. _(Kiryl Kaveryn)_
...
Olvasd el a [korábbi kiadási megjegyzéseket](@/news/2025-11-11/470/index.hu.md), ha lemaradtál róla.

### Béta tesztelési program

Csatlakozz a béta teszteléshez, hogy korai hozzáférést kapj az új funkciókhoz és segíts nekünk hamarabb megtalálni a hibákat:
- [iOS][testflight]
- [Android][firebase]

Az Organic Maps nem lenne lehetséges az [adományaid](@/donate/index.hu.md), [hozzájárulásaid és támogatásod](@/contribute/index.hu.md) nélkül ❤️
