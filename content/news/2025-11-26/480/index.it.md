---
title: "Nuova versione di Organic Maps 2025.11.25: Articoli Wikipedia in turco, giapponese e cinese, impostazione per vedere le regioni scaricate e altro!"
date: 2025-11-28
slug: "articoli-wikipedia-in-turco-giapponese-e-cinese-impostazione-per-vedere-le-regioni-scaricate-e-altro"
taxonomies:
  news: ["Releases"]
---
...
- Tocca il nome della lista nella pagina delle informazioni del luogo per selezionare una nuova lista per un segnalibro o traccia, e usa la nuova ricerca per trovare rapidamente la lista desiderata. _(Kiryl Kaveryn)_
- Corretto il layout della mappa durante la navigazione su iPad in modo che il percorso rimanga chiaramente visibile. _(Kiryl Kaveryn)_
...
- Migliorata l'importazione GeoJSON, inclusi i segnalibri `Saved Places.json` da [Google Takeout](https://takeout.google.com/) _(Sergiy Kozyr)_
- I file `.json` possono ora essere importati anche come file `.geojson`. _(Alexander Borsuk)_
- Quando sposti una traccia in una lista, quella lista diventa quella predefinita per nuovi segnalibri e tracce. _(Kiryl Kaveryn)_
- Aggiornate le traduzioni per più lingue, inclusa una correzione per l'ebraico. _(Alexander Borsuk, Michael Zeevi)_
- Semplificate le indicazioni per le rotonde. _(Viktor Govako)_

### Note di rilascio precedenti

Leggi le [note di rilascio precedenti](@/news/2025-11-11/470/index.it.md) se te le sei perse.

### Programma di beta testing

Unisciti al beta testing per ottenere accesso anticipato alle nuove funzionalità e aiutarci a trovare bug prima:
- [iOS][testflight]
- [Android][firebase]

Organic Maps non sarebbe possibile senza le vostre [donazioni](@/donate/index.it.md), [contributi e supporto](@/contribute/index.it.md) ❤️
