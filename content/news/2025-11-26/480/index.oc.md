---
title: "Nòva version d'Organic Maps 2025.11.25: Articles Wikipèdia en turc, japonés e chinés, paramètre per veire las regions telecargadas, e mai encara!"
date: 2025-11-28
...
- Apondut un paramètre que marca visualament las regions telecargadas sus la mapa en violet. _(Viktor Govako, Kiryl Kaveryn, Alexander Borsuk)_
- Donadas OpenStreetMap mesas a jorn al 23 de novembre de 2025. _(Viktor Govako)_
...
### Autras melhoraments
- Apondut emojis personalizats sus la Pagina d'Informacion del Luòc. _(David Martinez, Manish Rathaur, Andrei Shkrob)_
- Augmentada la luminositat e lo contraste dels camins en mòde veïcle escur. _(Manish Rathaur)_
- Lo guidatge per bicicleta salta ara las carrièras de residéncia a sens unic en Àustria. _(Viktor Govako)_
- Melhorada l'importacion GeoJSON, inclòs los marcapaginas `Saved Places.json` de [Google Takeout](https://takeout.google.com/) _(Sergiy Kozyr)_
- Los fichièrs `.json` pòdon ara èsser importats coma fichièrs `.geojson`. _(Alexander Borsuk)_
- Quand desplaçatz una traça cap a una lista, aquela lista ven la predefinida per los nòus marcapaginas e traças. _(Kiryl Kaveryn)_
- Mesas a jorn las traduccions per mai d'una lenga, inclòsa una correccion per l'ebrèu. _(Alexander Borsuk, Michael Zeevi)_
- Simplificadas las indicacions de rond-ponch. _(Viktor Govako)_

### Nòtas de versions precedentas

Legissètz las [nòtas de la version precedenta](@/news/2025-11-11/470/index.oc.md) se l'avètz mancat.

### Programa de tèst bèta

Refo al tèst bèta per obténer un accès anticipat a las nòvas foncionalitats e nos ajudar a trobar los bugs mai lèu:
- [iOS][testflight]
- [Android][firebase]

Organic Maps seriá pas possible sens vòstres [dons](@/donate/index.oc.md), [contribucions e suòrt](@/contribute/index.oc.md) ❤️
