---
title: "Nowa wersja Organic Maps 2025.11.25: Artykuły Wikipedii po turecku, japońsku i chińsku, ustawienie do wyświetlania pobranych regionów i więcej!"
date: 2025-11-28
slug: "artykuły-wikipedii-po-turecku-japońsku-i-chińsku-ustawienie-do-wyświetlania-pobranych-regionów-i-więcej"
taxonomies:
  news: ["Releases"]
---
...
- Ulepszony import GeoJSON, w tym zakładki `Saved Places.json` z [Google Takeout](https://takeout.google.com/) _(Sergiy Kozyr)_
- Pliki `.json` mogą być teraz również importowane jako pliki `.geojson`. _(Alexander Borsuk)_
- Gdy przenosisz trasę na listę, ta lista staje się domyślną dla nowych zakładek i tras. _(Kiryl Kaveryn)_
- Zaktualizowano tłumaczenia dla wielu języków, w tym poprawkę dla hebrajskiego. _(Alexander Borsuk, Michael Zeevi)_
- Uproszczone wskazówki dotyczące rond. _(Viktor Govako)_

### Poprzednie informacje o wydaniu

Przeczytaj [poprzednie informacje o wydaniu](@/news/2025-11-11/470/index.pl.md), jeśli je przegapiłeś.

### Program testów beta

Dołącz do testów beta, aby uzyskać wczesny dostęp do nowych funkcji i pomóc nam wcześniej znaleźć błędy:
- [iOS][testflight]
- [Android][firebase]

Organic Maps nie byłoby możliwe bez Waszych [darowizn](@/donate/index.pl.md), [wkładu i wsparcia](@/contribute/index.pl.md) ❤️
