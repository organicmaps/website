---
title: "Nova versão do Organic Maps 2025.11.25: Artigos da Wikipédia em turco, japonês e chinês, configuração para ver regiões baixadas e muito mais!"
date: 2025-11-28
slug: "artigos-da-wikipédia-em-turco-japonês-e-chinês-configuração-para-ver-regiões-baixadas-e-muito-mais"
taxonomies:
  news: ["Releases"]
---
...
- Arquivos `.json` agora também podem ser importados como arquivos `.geojson`. _(Alexander Borsuk)_
- Quando você move uma trilha para uma lista, essa lista se torna o padrão para novos marcadores e trilhas. _(Kiryl Kaveryn)_
- Atualizadas traduções para vários idiomas, incluindo uma correção para o hebraico. _(Alexander Borsuk, Michael Zeevi)_
- Simplificadas as instruções de rotatória. _(Viktor Govako)_

### Notas de versões anteriores

Leia as [notas da versão anterior](@/news/2025-11-11/470/index.pt-BR.md) se você perdeu.

### Programa de testes beta

Participe dos testes beta para ter acesso antecipado a novos recursos e nos ajudar a encontrar bugs mais cedo:
- [iOS][testflight]
- [Android][firebase]

O Organic Maps não seria possível sem suas [doações](@/donate/index.pt-BR.md), [contribuições e apoio](@/contribute/index.pt-BR.md) ❤️
