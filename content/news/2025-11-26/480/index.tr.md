---
title: "Yeni Organic Maps Sürümü 2025.11.25: Türkçe, Japonca ve Çince Wikipedia makaleleri, indirilen bölgeleri görme ayarı ve daha fazlası!"
date: 2025-11-28
...
### iOS
- YENİ! Yer Bilgi Sayfasında isme dokunarak yer imi veya rota adını doğrudan düzenleyebilirsiniz. _(Kiryl Kaveryn)_
- iOS 26 ve macOS 26 "Liquid Glass" desteği eklendi. _(Kiryl Kaveryn)_
- Seçilen yer veya yer iminin adını veya adresini panoya kopyalamak için uzun dokunun. _(Kiryl Kaveryn)_
- Yer Bilgi Sayfasında liste adına dokunarak yer imi veya rota için yeni bir liste seçin ve istediğiniz listeyi hızlıca bulmak için yeni aramayı kullanın. _(Kiryl Kaveryn)_
- iPad'de navigasyon sırasında harita düzeni düzeltildi, böylece rota açıkça görünür kalıyor. _(Kiryl Kaveryn)_
...
- [Google Takeout](https://takeout.google.com/)'tan `Saved Places.json` yer imleri dahil geliştirilmiş GeoJSON içe aktarma _(Sergiy Kozyr)_
- `.json` dosyaları artık `.geojson` dosyaları olarak da içe aktarılabilir. _(Alexander Borsuk)_
- Bir rotayı listeye taşıdığınızda, o liste yeni yer imleri ve rotalar için varsayılan olur. _(Kiryl Kaveryn)_
- İbranice için bir düzeltme dahil birden fazla dil için çeviriler güncellendi. _(Alexander Borsuk, Michael Zeevi)_
- Döner kavşak yönlendirmeleri basitleştirildi. _(Viktor Govako)_

### Önceki sürüm notları

Kaçırdıysanız [önceki sürüm notlarını](@/news/2025-11-11/470/index.tr.md) okuyun.

### Beta test programı

Yeni özelliklere erken erişim sağlamak ve hataları daha erken bulmamıza yardımcı olmak için beta testine katılın:
- [iOS][testflight]
- [Android][firebase]

Organic Maps [bağışlarınız](@/donate/index.tr.md), [katkılarınız ve desteğiniz](@/contribute/index.tr.md) olmadan mümkün olmazdı ❤️
