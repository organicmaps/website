...
- Yer Bilgi Sayfasında liste adına dokunarak yer imi veya rota için yeni bir liste seç ve istediğin listeyi hızlıca bulmak için yeni aramayı kullan. _(Kiryl Kaveryn)_
...
- Bir rotayı listeye taşıdığında, o liste yeni yer imleri ve rotalar için varsayılan olur. _(Kiryl Kaveryn)_
...
Kaçırdıysan [önceki sürüm notlarını](@/news/2025-11-11/470/index.tr.md) oku.

### Beta test programı

Yeni özelliklere erken erişim sağlamak ve hataları daha erken bulmamıza yardımcı olmak için beta testine katıl:
- [iOS][testflight]
- [Android][firebase]

Organic Maps [bağışların](@/donate/index.tr.md), [katkıların ve desteğin](@/contribute/index.tr.md) olmadan mümkün olmazdı ❤️
