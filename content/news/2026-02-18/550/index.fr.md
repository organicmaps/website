---
title: Mise à jour Organic Maps de février 2026
date: 2026-02-18
slug: mise-a-jour-organic-maps-fevrier-2026
taxonomies:
  news: ["Releases"]
---
...
* Données cartographiques OSM au 16 février
* Données Wikipédia au 1er février
* Les itinéraires de randonnée et cyclables noirs sont désormais visibles dans le thème sombre (Viktor Govako)
* Ajout de plus de services automobiles : réparation, entretien et pièces (Viktor Govako)
* Correction de l'accès vélo sur certains types de routes (Viktor Govako)
* Correction du calcul de la vitesse moyenne (Viktor Govako)
...
* Ajout de l'authentification navigateur OSM et du logo (Rahul Kolluru)

### Android

* Heures d'ouverture extensibles (Rover track)
* Correction de l'affichage des heures d'ouverture (DaN0mic)
...
* Suppression des noms de villes en double dans certaines régions (alnzrv)
* Correction des instructions vocales en hébreu (mattanelkaim)
* Correction de coquilles en coréen (Parkjju)
* Ajout de synonymes de recherche en russe (ednzxt)
* Amélioration des instructions vocales en allemand (Navigator72)
* Correction de la traduction manquante pour tunnel ferroviaire désaffecté (pranjaldubey022)
* Correction de la traduction du pays en roumain (Eugen Dedu)
* Ajout des traductions en lao et arménien (Viktor Govako)
* Ajout de traductions arméniennes manquantes (Alexander Borsuk)
...
Chaque [don](@/donate/index.fr.md) et [contribution](@/contribute/index.fr.md) nous aide à construire une meilleure alternative à Apple et Google Maps, centrée sur la confidentialité.
