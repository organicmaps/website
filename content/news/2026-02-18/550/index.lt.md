---
title: Organic Maps 2026 m. vasario atnaujinimas
date: 2026-02-18
...
* OSM žemėlapio duomenys nuo vasario 16 d.
* Vikipedijos duomenys nuo vasario 1 d.
* Juodi pėsčiųjų ir dviračių maršrutai dabar matomi tamsioje temoje (Viktor Govako)
* Pridėta daugiau automobilių paslaugų: remontas, aptarnavimas ir dalys (Viktor Govako)
* Pataisytas dviračių eismas kai kuriuose kelių tipuose (Viktor Govako)
* Pataisytas vidutinio greičio skaičiavimas (Viktor Govako)
...
* Pridėtas OSM naršyklės autentifikavimas ir logotipas (Rahul Kolluru)
...
* Pašalinti pasikartojantys miestų pavadinimai kai kuriuose žemėlapio regionuose (alnzrv)
* Pataisyti hebrajų balso nurodymai (mattanelkaim)
* Pataisytos korėjiečių kalbos klaidos (Parkjju)
* Pridėti rusiški paieškos sinonimai (ednzxt)
* Pagerinti vokiški balso nurodymai (Navigator72)
* Pataisytas trūkstamas vertimas nenaudojamam geležinkelio tuneliui (pranjaldubey022)
* Pataisytas šalies vertimas rumunų kalba (Eugen Dedu)
* Pridėti laosiečių ir armėnų vertimai (Viktor Govako)
* Pridėti trūkstami armėnų vertimai (Alexander Borsuk)
...
Kiekviena [auka](@/donate/index.lt.md) ir [indėlis](@/contribute/index.lt.md) padeda mums kurti geresnę, į privatumą orientuotą alternatyvą Apple ir Google Maps.
