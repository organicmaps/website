---
title: "Límites de velocidad condicionales, isolíneas más detalladas para China, regiones divididas/reducidas de Tanzania, tiendas de cuero y mucho más en la actualización de marzo de Organic Maps"
date: 2026-03-12
...
* Añadido soporte para límites de velocidad condicionales (Abdelhadi Wael, Viktor Govako)
* Añadidas tiendas de cuero y de artículos religiosos (Viktor Govako)
* Añadidas filas de árboles (Viktor Govako)
* Añadidas plataformas de paradas de transporte público sin paradas de autobús cercanas (Viktor Govako)
* Dividir Tanzania en regiones más pequeñas (Emile Villette, Viktor Govako)
* Corregido el cálculo del progreso de descarga de países (Kiryl Kaveryn)
...
* Actualizadas las traducciones de los colaboradores de Weblate (Viktor Govako)
* Corregida la traducción al ucraniano (Nnifria)

Únete a las pruebas beta para probar las primeras funciones y notificar problemas:
- [iOS][testflight]
- [Android][firebase]

Cada [donación](@/donate/index.es.md) y [contribución](@/contribute/index.es.md) nos ayuda a construir una alternativa mejor, centrada en la privacidad, gratuita y de código abierto a Apple y Google Maps.
