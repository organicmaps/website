---
title: "三月更新的Organic Maps中包括有条件的速度限制、更详细的中国等高线、分割/缩小的坦桑尼亚地区、皮革商店等内容"
date: 2026-03-12
...
附注：如果你对 iOS/Android/Linux/MacOS/Windows SDK 以及可在你的项目中重复使用的离线地图感兴趣，请发送电子邮件至 <sdk@organicmaps.app> 联系我们。
...
每一笔[捐款](@/donate/index.zh-Hans.md)和[贡献](@/contribute/index.zh-Hans.md)都有助于我们打造一个更好的、注重隐私的、免费开源的 Apple Maps 和 Google Maps 替代品。
