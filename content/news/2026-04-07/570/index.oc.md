---
title: "Itineraris de randonada e de ciclisme amb perfils d'altitud, recèrca d'adreças estatsunidencas mai intelligenta, continuitat fluida de la mapa a l'antimeridian, e mai encara dins la mesa a jorn Organic Maps d'abril"
date: 2026-04-07
...
- La mapa passa ara corrèctament per l'antimeridian (±180° de longitud) pendent lo desplaçament e la rotacion (Alexander Borsuk, Viktor Govako)
- La navigacion ciclista utiliza ara lo cap de la bossòla a bassa velocitat (HossamSaberr)
- Melhorament de la recèrca d'adreças per numèro d'ostal (Viktor Govako)
- Correccion d'una error sistèma al moment de la planificacion d'itineraris a proximitat de certanas frontièras regionalas (Viktor Govako)
- Correccion dels resultats de recèrca quand los noms de vila e d'estat son identics (Viktor Govako)
- Apond de sinonims de carrièras estatsunidencas : highway, hwy, freeway, e fwy (Viktor Govako)
- Correccion del desalinhament del reticul de l'editor al moment de quichar « Apondre un luòc » (José Araújo)
- Correccion de l'afichatge dels oraris de dobertura pels luòcs amb decalatges al levar/colcar del solelh (Alexander Borsuk)
- Correccion de l'enregistrament de traça GPS que perdia de punts entre los segments (Alexander Borsuk)
- Correccion de la gestion de l'ora d'estiu pels fuses oraris (Andrei Shkrob)
- Correccion de las colors de las linhas de mètro de Sydney (Alexander Borsuk)
- Correccion de l'importacion GeoJSON (Alexander Borsuk)
- Melhorament de l'estabilitat e de las performàncias (Alexander Borsuk, Viktor Govako)
- Traduccions mesas a jorn (Alexander Borsuk, Viktor Govako, contributors Weblate)
...
- Amaga lo boton de telecargament quand totas las mapas son ja telecargadas (Mikhail Listratsenka)
- Correccion de l'enviament de las modificacions de mapa a OpenStreetMap (Viktor Govako)
- Correccion del partatge de fichièrs cap a Google Drive e d'autras aplicacions (Alexander Borsuk)
- Correccion de la reïmportacion de las marcas al moment de la reubertura de l'aplicacion dempuèi las aplicacions recentas (Alexander Borsuk)
- Dobrir d'URL de recèrca OpenStreetMap coma `openstreetmap.org/search?query=Pizza` avia ara la recèrca dins Organic Maps (Rawdyrathaur)
- Correccion de mantun plantatge (Alexander Borsuk)

### Ordenador de burèu (Linux e Mac OS)

- Apond la possibilitat de seleccionar una traça guida pel calcul d'itinerari (Viktor Govako)
