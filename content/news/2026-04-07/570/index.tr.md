---
title: "Organic Maps'in Nisan güncellemesinde yükseklik grafikli yürüyüş ve bisiklet rotaları, daha akıllı ABD adres araması, antimeridyende kesintisiz harita kaydırma ve daha fazlası"
date: 2026-04-07
...
- Sidney metro hattı renkleri düzeltildi (Alexander Borsuk)
- GeoJSON içe aktarımı düzeltildi (Alexander Borsuk)
- Geliştirilmiş kararlılık ve performans (Alexander Borsuk, Viktor Govako)
- Güncellenmiş çeviriler (Alexander Borsuk, Viktor Govako, Weblate'e katkıda bulunanlar)
...
- Tüm haritalar zaten indirilmişse indirme düğmesi gizlenir (Mikhail Listratsenka)
- Harita düzenlemelerinin OpenStreetMap'e yüklenmesi düzeltildi (Viktor Govako)
- Google Drive ve diğer uygulamalarla dosya paylaşımı düzeltildi (Alexander Borsuk)
- Uygulama son uygulamalar ekranından yeniden açıldığında yer imlerinin yeniden içe aktarılması düzeltildi (Alexander Borsuk)
- OpenStreetMap arama URL'lerini `openstreetmap.org/search?query=Pizza` gibi açmak artık aramayı Organic Maps'te başlatıyor (Rawdyrathaur)
- Birkaç çökme düzeltildi (Alexander Borsuk)

### Masaüstü (Linux ve Mac OS)

- Rotalama için bir kılavuz izi seçme özelliği eklendi (Viktor Govako)
