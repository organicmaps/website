...
- Pridėtas „Lookout“ kaip apžvalgos vietų paieškos sinonimas (alnzrv)
- Pridėtas „pkwy“ kaip JAV gatvių pavadinimų sinonimas (Viktor Govako)
- Pėsčiųjų zonų spalvos šiek tiek patamsintos, kad būtų geriau įskaitomos (Viktor Govako)
- Kelių eilučių tekstas dabar žemėlapyje apkarpomas tvarkingai (Viktor Govako)
- Gatvių pavadinimuose nebėra pasikartojančių dalių (Viktor Govako)
- Ištaisytas KMB failų importas (Alexander Borsuk)
- Atnaujinti kategorijų, paieškos sinonimų ir naudotojo sąsajos eilučių vertimai (Alexander Borsuk, Viktor Govako)
- Išversti Naujojo Pietų Velso ir Šiaurės teritorijos aprašymai (alnzrv)
- Pagerintas stabilumas ir našumas, įskaitant šriftų formavimą, glifų kaupimą talpykloje ir maršruto linijų apkarpymą (Viktor Govako, Alexander Borsuk)

### iOS

- NAUJA! Į navigacijos informacijos skydelį pridėtas trasos įrašymo mygtukas (Kiryl Kaveryn)
- NAUJA! Navigacijos skydelyje pridėti du papildomi žingsniai, skirti tikslesnei informacijai apie aukštį ir maršrutą (Kiryl Kaveryn)
- Atnaujintas aukščio grafiko stilius navigacijos skydelyje, teisingai atvaizduojant trasas su neigiamu aukščiu (Kiryl Kaveryn)
- Ištaisyta klaida, dėl kurios TestFlight versijoje buvo rodomas neteisingas žymų sąrašas (Alexander Borsuk)
- Didesnis mygtukas „Stop“ ir didesnės lietimo sritys navigacijos apatinio skydelio mygtukams: TTS nutildymui, nustatymams, trasos įrašymui (Kiryl Kaveryn)
- Patobulinta išskleidžiamo aprašymo skyriaus animacija vietos puslapyje (Kiryl Kaveryn)
- Vietos puslapis nebeužsidaro pasibaigus aukščio grafiko perbraukimui, nebešokčioja netikėtai, o redaguojant su atverta klaviatūra pavadinimas lieka matomas (Kiryl Kaveryn)
- Ištaisytos aukščio grafiko ir apskrito eigos indikatoriaus spalvų problemos, kai pasikeičia sistemos išvaizda (Kiryl Kaveryn)
- Ištaisytos programos strigtys trinant trasą ar žymą, kurios jau nebeegzistuoja (Kiryl Kaveryn)

### Android

- NAUJA! Nuolatinis aukščio skydelis ir patobulintas maršruto aukščio profilis su tinkamu RTL išdėstymu (Eric Jau, Mikhail Listratsenka)
- Išsaugota maršruto būsena dabar išlieka pasukus įrenginį (Mikhail Listratsenka)
- Viena bendra maršruto nuorodos linija vietos puslapyje (Mikhail Listratsenka)
- Didesnis apatinių skydelių, mygtukų ir grafinių elementų kampų spindulys, kad išvaizda būtų nuoseklesnė (Mikhail Listratsenka)
- Ištaisyti išdėstymo trikdžiai aplink sistemos juostas ir navigacijos juostą (Mikhail Listratsenka)
- Pagerintas Vikipedijos straipsnių rodymas: geresnis formatavimas, sistemos spalvos ir tamsaus režimo tvarkymas (DeshDeepakKant, Mikhail Listratsenka)
- Pridėti vertikalūs skyrikliai tarp kelių geometrijų trasų segmentų aukščio grafike (Mikhail Listratsenka)
- Pagerintas aukščio grafiko slinkimas (Mikhail Listratsenka)
- Ištaisyti iš dešinės į kairę (RTL) išdėstymo trūkumai (Mikhail Listratsenka)

### Linux ir Mac OS

- Pridėtas viešojo transporto maršruto parinkiklis, leidžiantis pasirinkti konkrečią transporto liniją, kai pasirinkta stotelė (Viktor Govako)
- Maršruto veiksmų mygtukai rodomi tiesiogiai vietos puslapyje (Viktor Govako)
- Pašalintas pasikartojantis darbo laikas iš vietos puslapio (Viktor Govako)
- Tarpinė maršruto žymė ant lankytinos vietos arba adreso dabar rodo vietos pavadinimą (Viktor Govako)
...
Mes mylime savo naudotojus ❤️ ir mylime tai, ką darome
