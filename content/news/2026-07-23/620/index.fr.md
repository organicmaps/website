---
title: "Corrections de bugs et améliorations concernant les transports en commun, le calcul d’itinéraires, la recherche et les favoris dans la mise à jour de juillet 2026"
date: 2026-07-23
...
Comme vous l’avez peut-être déjà remarqué, la mise à jour de juillet d’Organic Maps est disponible. Vous pouvez la télécharger sur <https://get.omaps.org> ou sur [App Store][appstore], [Google Play][googleplay], [Huawei AppGallery][appgallery], [Obtainium][obtainium], [Accrescent][accrescent] et [F-Droid][fdroid].

Grâce à vos [dons](@/donate/index.fr.md) et à vos [commentaires](@/contribute/index.fr.md), nous nous sommes concentrés en juillet sur la correction de bugs et l’apport d’améliorations. Au cas où vous l’auriez manqué, les fonctionnalités suivantes de la [version précédente de juin](@/news/2026-06-29/610/index.fr.md) sont également disponibles :
...
- Les notes signalées à [OpenStreetMap](https://www.openstreetmap.org) sont désormais placées à l’endroit précis que vous avez sélectionné, et non plus au milieu de la rue ou de la zone concernée _(Alexander Borsuk)_
...
- La couche « Métro » s’affiche à nouveau correctement une fois que vous avez fermé l’aperçu d’un itinéraire en transports en commun _(Mikhail Listratsenka)_
...
### iOS
- Nouveau paramètre « Enregistrer l’historique de recherche » qui vous permet de désactiver l’historique et de le masquer si vous préférez ne pas le conserver _(Kiryl Kaveryn)_
- Nouveau bouton « Modifier » pour supprimer plus facilement les signets _(Kiryl Kaveryn)_
- Les signets sont désormais enregistrés automatiquement lorsque vous quittez l’écran _(Kiryl Kaveryn)_
- La palette de couleurs propose désormais des couleurs prédéfinies et vous permet de choisir n’importe quelle couleur personnalisée _(Kiryl Kaveryn)_
