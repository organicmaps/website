...
Esta aplicación está licenciada baixo a licenza Apache, versión 2.0 (a "Licenza"); non pode usar esta aplicación excepto en cumprimento da Licenza.
...
Consulte os seus ficheiros de LICENZA, COPIA ou AVISO para coñecer os termos de uso.

Consulte tamén o ficheiro [data/copyright.html][copyright] para obter unha lista completa de avisos de copyright para a aplicación Organic Maps.

Se tes algunha pregunta ou suxestión, póñase en contacto connosco en [legal@organicmaps.app](mailto:legal@organicmaps.app).
