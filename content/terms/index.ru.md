...
Вы можете получить копию Лицензии по адресу [http://www.apache.org/licenses/LICENSE-2.0][license].
...
Почти всё программное обеспечение, находящееся в следующих папках на [GitHub][github], создано другими людьми и организациями и лицензируется другими способами:
...
См. также файл [data/copyright.html][copyright] с полным списком уведомлений об авторских правах для приложения Organic Maps.
